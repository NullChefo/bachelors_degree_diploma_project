...
import com.stefan.mailservice.messaging.MailConsumer;
import com.stefan.mailservice.messaging.MailProducer;
import com.stefan.mailservice.repository.MailListRepository;
...
public class MailService {
	...
	public void processAndSend(final Mail mail) {
		...
		mailList.setSendedMailsForUser(mailList.getSendedMailsForUser() + 1);
		// TODO Review Later
