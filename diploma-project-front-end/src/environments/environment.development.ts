...
// export const POST_ENDPOINT = API_URI + "/social-media/social-media/v1/post";
// export const GROUP_ENDPOINT = API_URI + "/social-media/social-media/v1/group";
// export const MESSAGE_ENDPOINT = API_URI + "/social-media/social-media/v1/message";
// export const CONNECTION_ENDPOINT = API_URI + "/social-media/social-media/v1/connection";
// export const MEDIA_ENDPOINT = API_URI + "/social-media/social-media/v1/media";
// export const FEED_ENDPOINT = API_URI + "/social-media/social-media/v1/feed";
// export const LIKE_ENDPOINT = API_URI + "/social-media/social-media/v1/like";
